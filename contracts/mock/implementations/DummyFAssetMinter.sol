 ...
 * @notice A minter contract for FAsset tokens which implements the Flare collateralization framework.
 ...
 **/
contract DummyFAssetMinter is ICollateralizable {
    using SafeMath for uint256;

    FAssetToken public immutable mintableToken;
