...
export async function deployContracts(hre: HardhatRuntimeEnvironment, parameters: any, quiet: boolean = false) {
  ...
  await initialAirdrop.setLatestAirdropStart(parameters.initialAirdropLatestStart);
