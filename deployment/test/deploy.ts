...
// NOTE: since the access to the list of daemonized contracts is not public anymore, this function has become obsolete.
...
contract(`deploy.ts system tests`, async accounts => {
  ...
  describe(Contracts.FLARE_DAEMON, async () => {
    ...
    // NOTE: since access to list of daemonized contracts is not public, these tests are irelevant.
