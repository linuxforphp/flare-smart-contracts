 ...
 */
contract(`FlareKeeper.sol; ${getTestFile(__filename)}; Minting system test limits`, async accounts => {
  ...
  describe("mint", async() => {
    it("Should not mint", async() => {
      ...
      await flareKeeper.setMaxMintingRequest(web3.utils.toWei(BN(50000000)).add(BN(1)));
      // Act
